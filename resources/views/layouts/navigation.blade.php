<nav x-data="{ open: false }" class="bg-chef-gray border-b border-chef-gray-light sticky top-0 z-50 shadow-soft">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @if(auth()->user()->isLearner() && !auth()->user()->hasCompletedProfile())
                            <x-dropdown-link :href="route('profile.complete')" class="text-yellow-400">
                                {{ __('Complete Profile') }}
                            </x-dropdown-link>
                        @endif
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-2xl text-gray-400 hover:text-chef-gold hover:bg-chef-gray-light focus:outline-none focus:bg-chef-gray-light focus:text-chef-gold transition-all duration-300">
