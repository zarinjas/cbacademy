<x-guest-layout>
    <div class="min-h-screen flex flex-col items-center justify-center text-center px-6">
        ...
        <div class="max-w-2xl mx-auto">
            <!-- 404 Number -->
            <div class="text-9xl font-bold text-chef-gold mb-6 leading-none">
                404
            </div>
            ...
            <p class="text-xl text-gray-300 mb-8 leading-relaxed">
                Oops! The page you're looking for seems to have wandered off into the trading wilderness. 
                Don't worry, even the best traders sometimes take wrong turns.
            </p>
            ...
            <div class="mt-12 p-6 bg-chef-gray border border-chef-gray-light rounded-2xl">
                ...
                <p class="text-gray-300">
                    "In trading, as in life, the best strategy is to stay focused on your goals and not get distracted by market noise."
                </p>
            </div>
        </div>
    </div>
