                ...
                <form action="{{ route('admin.lessons.store', $course) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            required 
                            class="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-chef-gold focus:border-transparent"
                            placeholder="Enter the lesson content...">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            <option value="google_drive" {{ old('video_type', 'youtube') === 'google_drive' ? 'selected' : '' }}>Google Drive</option>
                        </select>
                    </div>

                    <!-- YouTube URL Field -->
                    <div id="youtube-url-field" class="{{ old('video_type', 'youtube') === 'google_drive' ? 'hidden' : '' }}">
                    ...
                    <div id="google-drive-url-field" class="{{ old('video_type', 'youtube') === 'google_drive' ? '' : 'hidden' }}">
