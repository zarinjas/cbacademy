<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-chef-gold">{{ $course->getTotalLessonsCount() }}</div>
                                    <div class="text-sm text-gray-400">Lessons</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-chef-gold">{{ $course->getTotalDurationFormatted() }}</div>
                                    <div class="text-sm text-gray-400">Duration</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-chef-gold">{{ $course->freePreviewLessons()->count() }}</div>
                                    <div class="text-sm text-gray-400">Free Previews</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-chef-gold">Beginner</div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                ...
                                @endif
                                <x-app.button variant="secondary">
                                    Add to Wishlist
                                </x-app.button>
                            </div>
                        </div>
            ...
            <!-- Lessons List -->
            <div class="mb-8">
                <h3 class="text-2xl font-bold text-white mb-6">Course Content</h3>
                        ...
                        <x-app.card class="hover:shadow-soft-lg transition-all duration-300">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    <!-- Lesson Number -->
                                    <div class="w-12 h-12 bg-chef-gold rounded-2xl flex items-center justify-center">
                                        <span class="text-chef-black font-bold text-lg">{{ $index + 1 }}</span>
                                    </div>
                    ...
                    @empty
                        <x-app.card>
                            <div class="text-center py-8">
                                ...
                                <h4 class="text-lg font-semibold text-white mb-2">No Lessons Available</h4>
                                <p class="text-gray-400">This course doesn't have any lessons yet.</p>
                            </div>
                        </x-app.card>
                    @endforelse
                </div>
